 ...
 * [com.ttcn.promotionsdk.promotionsdkui.feature.promotion.endowview.PRMEndowView] và truyền lại cho
 * [com.ttcn.promotionsdk.promotionsdkui.feature.promotion.endowview.PRMEndowView.setDiscountDetails].
 * Thay cho DTO data-layer trước đây để không rò chi tiết tầng data ra public API.
 *
 * Lưu ý: [PRMSDKCallback.onVoucherApplied] (thống nhất với iOS) chỉ trả `voucherId`; chi tiết
 * giảm giá đi theo luồng widget ở trên, không qua callback.
 */
data class PRMAppliedDiscount(
    val objectId: String,
