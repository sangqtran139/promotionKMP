...
import com.ttcn.promotionsdk.promotionsdkui.di.PromotionViewModelFactory
import com.ttcn.promotionsdk.promotionsdkui.feature.promotion.choosepromotion.adapter.ChoosePromotionListItem
import com.ttcn.promotionsdk.promotionsdkui.feature.promotion.choosepromotion.adapter.ChoosePromotionMainAdapter
...
import com.ttcn.promotionsdk.promotionsdkui.utils.extension.PRMVerticalSpaceItemDecoration

class PRMChoosePromotionFragment : PRMBaseFragment<FragmentChoosePromotionBinding>() {
    ...
    private fun setupRecyclerView() {
        ...
        binding.rcvVoucher.apply {
            ...
            adapter = mainAdapter
            addItemDecoration(
                PRMVerticalSpaceItemDecoration(
                    0,
    ...
    /** Cùng khuôn với `PRMSearchMyPromotionFragment`: gõ mỗi ký tự → `QueryChanged` (ViewModel tự debounce). */
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun forEndowView(endowView: PRMEndowView): PRMChoosePromotionFragment =
            PRMChoosePromotionFragment().apply {
