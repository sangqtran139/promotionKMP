package com.ttcn.promotionsdk.promotionsdkui.feature.promotion.searchmypromotion
...
import com.ttcn.promotionsdk.promotionsdkui.utils.extension.hideSoftInput

class PRMSearchMyPromotionFragment : PRMBaseFragment<FragmentSearchMyPromotionBinding>() {
    ...
    /** Giống hệt `PRMMyPromotionFragment.showServiceSelector` — cùng bottom sheet, cùng sự kiện host. */
