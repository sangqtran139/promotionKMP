...
import com.ttcn.promotionsdk.promotionsdkui.di.PromotionViewModelFactory
import com.ttcn.promotionsdk.promotionsdkui.feature.promotion.mypromotion.ServiceSelectorBottomSheet
import com.ttcn.promotionsdk.promotionsdkui.feature.promotion.mypromotion.ServiceSelectorUiItem
import com.ttcn.promotionsdk.promotionsdkui.feature.promotion.promotiondetail.adapter.PRMCustomFragmentPagerAdapter
...
import com.ttcn.promotionsdk.promotionsdkui.utils.loadPromotionVoucherBanner
import com.ttcn.promotionsdk.promotionsdkui.utils.loadPromotionVoucherLogo

class PRMDetailFragment : PRMBaseFragment<FragmentDetailPromotionBinding>() {
    ...
    companion object {
         ...
         */
        fun newInstance(voucherId: String): PRMDetailFragment {
            return PRMDetailFragment().apply {
