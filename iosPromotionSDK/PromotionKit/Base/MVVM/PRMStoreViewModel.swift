...
/// Bọc store — **không** biết gì về điều hướng, nên dùng được cho cả widget (`PRMOfferWidget`) lẫn
...
class PRMStoreViewModel<Store: PRMStoreBridge> {
    ...
    ///
    /// Widget `PRMOfferWidget` **tắt** cái này: nó phải giữ lỗi lại cho tới khi vòng validate kết thúc
    /// (xem `OfferWidgetViewModel.handleSettle`), tự xoá sớm là nuốt mất lỗi ngay lúc user đang chờ kết
...
extension OfferWidgetStore: PRMStoreBridge {}
