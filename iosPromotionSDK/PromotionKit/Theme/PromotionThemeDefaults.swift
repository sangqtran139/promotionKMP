...
enum PromotionThemeDefaults {
    ...
    static var button: PRMButtonToken {
        PRMButtonToken(
    ...
    static var searchBar: PRMSearchBarToken {
        PRMSearchBarToken(
    ...
    /// Android.
    static var listItem: PRMListItemToken {
        PRMListItemToken(
    ...
    /// Tab dạng chip.
    static var tabChip: PRMTabChipToken {
        PRMTabChipToken(
    ...
    /// Tab gạch chân.
    static var tabUnderline: PRMTabUnderlineToken {
    ...
    /// Badge giảm giá.
    static var discountBadge: PRMDiscountBadgeToken {
