...
final class SearchMyPromotionViewController: PRMBaseViewController<SearchMyPromotionViewModel> {
    ...
    override func setupAccessibility() {
        ...
        self.searchTextField.accessibilityIdentifier = PRMAccessibilityID.Search.searchField
        self.tableView.accessibilityIdentifier = PRMAccessibilityID.Search.table
        self.resultSearchLabel.accessibilityIdentifier = PRMAccessibilityID.Search.resultLabel
    }
