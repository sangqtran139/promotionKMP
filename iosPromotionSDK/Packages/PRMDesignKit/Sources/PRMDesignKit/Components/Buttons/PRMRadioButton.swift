...
@IBDesignable
public class PRMRadioButton: UIView {
    
    private let radioSize = Sizing.tokenSizing24
    private let bundle = Bundle(for: PRMRadioButton.self)
...
extension PRMRadioButton: RadioButtonStateDelegate {
    @objc
