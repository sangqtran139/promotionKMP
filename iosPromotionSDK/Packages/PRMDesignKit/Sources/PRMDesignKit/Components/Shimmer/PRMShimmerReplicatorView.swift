//
//  PRMShimmerReplicatorView.swift
//  CoreUIKit
//

import UIKit

/// This class replicates the specified `PRMShimmerReplicatorViewCell` inside its frame in horizontal and vertical direction.
/// This class make it easy to create list type loading indicator very easily.
public class PRMShimmerReplicatorView: UIView {//swiftlint:disable line_length
    ...
    private let cellProvider: () -> PRMShimmerReplicatorViewCell
    ...
    ///   - cellProvider: A closure to create an instance of `PRMShimmerReplicatorViewCell`.
    public init(itemSize: ItemSize, interitemSpacing: CGFloat = 0, lineSpacing: CGFloat = 0, inset: UIEdgeInsets = .zero, horizontalEdgeMode: EdgeMode = .beyond, verticalEdgeMode: EdgeMode = .beyond, cellProvider: @escaping () -> PRMShimmerReplicatorViewCell) {
    ...
    public func startAnimating() {
        isAnimating = true
        stackView.arrangedSubviews.compactMap { $0 as? PRMShimmerReplicatorViewCell }.forEach {
            $0.startAnimating()
        }
    }
