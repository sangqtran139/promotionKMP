...
@objc
public class PRMLogger: NSObject {
    ...
    /// An identifier of the creator of this `PRMLogger`.
...
extension PRMLogger {
    ...
    ///            defaults to `#line`).
    ///    - fileName: The name of the file will be saved on disk, defaut by `PRMLogger.log`.
...
extension PRMLogger {
    ...
    ///
    /// If `.debug` is at least as severe as the `PRMLogger`'s `logLevel`, it will be logged,
    /// otherwise nothing will happen.
    ///
    /// - parameters:
    ///    - message: The message to be logged. `message` can be used with any string interpolation literal.
    ...
    ///
    /// If `.info` is at least as severe as the `PRMLogger`'s `logLevel`, it will be logged,
    /// otherwise nothing will happen.
    ///
    @objc
    ...
    ///
    /// If `.warning` is at least as severe as the `PRMLogger`'s `logLevel`, it will be logged,
    /// otherwise nothing will happen.
    @objc
    ...
    ///
    /// If `.error` is at least as severe as the `PRMLogger`'s `logLevel`, it will be logged,
    /// otherwise nothing will happen.
    ///
    @objc
