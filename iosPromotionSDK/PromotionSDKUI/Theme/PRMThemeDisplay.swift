//
//  PRMThemeDisplay.swift
//  PRMSDK
//
//  Biểu diễn token dạng **chuỗi hex**, phục vụ màn cấu hình theme của host.
//  Đối ứng 1-1 với `PRMThemeDisplay.kt` bên Android: cùng tên type, cùng tên field,
//  cùng `load` / `mergeWithSaved` / `themeFromDisplayValues` / `toToken`.
//
//  Khác `PRMSDKTheme`: ở đây **nhóm luôn có mặt**, chỉ leaf mới nullable — vì màn preview cần
//  hiển thị giá trị mặc định của SDK cho từng ô. Còn `PRMSDKTheme` để nhóm nullable, vì
...
public enum PRMThemeDisplay {
    ...
    /// Giá trị mặc định của SDK ở dạng hex. Đối ứng `PRMThemeDisplay.load(context)`.
    public static func load() -> Defaults { fromTheme(PRMThemeDefaults.theme) }

    /// Phủ theme đã lưu lên default: field nào `saved` có thì thắng.
    public static func mergeWithSaved(sdk: Defaults, saved: PRMSDKTheme?) -> Defaults {
    ...
    public static func themeFromDisplayValues(_ display: Defaults, sdk: Defaults) -> PRMSDKTheme {
        PRMSDKTheme(
    ...
    private static func fromTheme(_ t: PRMSDKTheme) -> Defaults {
...
private extension PRMThemeDisplay.ButtonValues {
...
private extension PRMThemeDisplay.SearchBarValues {
    func merged(with o: Self) -> Self {
...
private extension PRMThemeDisplay.ListItemValues {
    func merged(with o: Self) -> Self {
...
private extension PRMThemeDisplay.TabChipValues {
    func merged(with o: Self) -> Self {
...
private extension PRMThemeDisplay.TabUnderlineValues {
    func merged(with o: Self) -> Self {
...
private extension PRMThemeDisplay.DiscountBadgeValues {
    func merged(with o: Self) -> Self {
...
public extension PRMThemeDisplay.ButtonValues {
...
public extension PRMThemeDisplay.SearchBarValues {
...
public extension PRMThemeDisplay.ListItemValues {
...
public extension PRMThemeDisplay.TabChipValues {
...
public extension PRMThemeDisplay.TabUnderlineValues {
...
public extension PRMThemeDisplay.DiscountBadgeValues {
