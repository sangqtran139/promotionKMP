...
public enum PRMThemeDefaults {
    ...
    public static var button: PRMButtonToken {
        PRMButtonToken(
    ...
    public static var searchBar: PRMSearchBarToken {
        PRMSearchBarToken(
    ...
    /// Android.
    public static var listItem: PRMListItemToken {
        PRMListItemToken(
    ...
    /// Tab dạng chip.
    public static var tabChip: PRMTabChipToken {
        PRMTabChipToken(
    ...
    /// Tab gạch chân.
    public static var tabUnderline: PRMTabUnderlineToken {
    ...
    /// Badge giảm giá.
    public static var discountBadge: PRMDiscountBadgeToken {
    ...
    /// Theme mặc định đầy đủ. Đối ứng `PRMThemeDefaults.theme(context)` bên Android.
    public static var theme: PRMSDKTheme {
        PRMSDKTheme(
            buttonToken: button,
    ...
    /// `#AARRGGBB`, rút gọn `#RRGGBB` khi màu đục. Đối ứng `PRMThemeDefaults.colorToHex`.
