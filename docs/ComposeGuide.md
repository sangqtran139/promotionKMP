...
([AndroidUIGuide.md](./AndroidUIGuide.md)), UIKit trên iOS ([IosUIGuide.md](./IosUIGuide.md)).
...
- Theme Compose phải map từ token của `PromotionSDKTheme` / `VDSPromotionTheme` để giữ khả năng
