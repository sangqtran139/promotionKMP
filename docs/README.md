...
| `:networkKit` (KMP) | 🚧 Phase 1, UC1 xong — `HttpClient` factory per-instance (baseUrl/timeout), chưa header/token/parsing, chưa tích hợp vào `promotionLogic`. Xem [common/SharedNetworkKit.md](./common/SharedNetworkKit.md). |
