...
| `:networkKit` (KMP) | 🚧 Phase 1, UC5 xong — `HttpClient` factory + header tĩnh/động + token provider + request builder + giải mã JSON generic, chưa tích hợp vào `promotionLogic`. Xem [common/SharedNetworkKit.md](./common/SharedNetworkKit.md). |
