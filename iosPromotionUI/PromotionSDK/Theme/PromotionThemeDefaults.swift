...
//
//  **Màu khớp Android.** Trước đây iOS chọn nhầm token CoreUI (`tokenRed100 = #FF645C` thay vì
//  `tokenViettelPayRed100 = #EE0033`, `tokenDark60` thay vì `tokenDark100`…) nên lệch. Nay dùng đúng
//  token của design system CoreUI có giá trị **bằng** `R.color.*` bên Android — đối chiếu từng dòng:
//
