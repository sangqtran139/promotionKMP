...
final class PromotionDetailViewController: BaseViewController<PromotionDetailViewModel> {
    ...
    @IBOutlet private weak var applyButton: VDSButton!
...
extension PromotionDetailViewController: UnderlinedSegmentControlViewDelegate {
    func segmentControl(_ segmentControl: PromotionUI.UnderlinedSegmentControlView, didSelectItemAt index: Int) {
