...
public class PromotionHeaderView: UIView {
    ...
    public var promotionIcon: UIImage? = UIImage.sdk("ic_default_coupone", in: .module) {
        didSet {
    ...
    public var backIcon: UIImage? = UIImage.sdk("ic_arrow_left", in: .module) {
        didSet {
    ...
    public var searchIcon: UIImage? = UIImage.sdk("ic_search", in: .module) {
        didSet {
    ...
    public let backButton: TapableView = {
    ...
    public let searchButton: TapableView = {
        let view = TapableView()
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    }()
    ...
    private let backgroundGradientView: MultiRadialGradientView = {
        let view = MultiRadialGradientView()
    ...
    public func updateBackground(backgroundColor: UIColor? = nil, blobs: [MultiRadialGradientView.RadialBlob]? = nil) {
