...
final class UnderlinedSegmentControlItem: TapableView {
    //MARK: - Properties
    public var id = UUID()
    ...
    private var lineView: BaseView!

    /// Theme token host cấu hình (nil = giữ default SDK).
    private var themeToken: VDSTabUnderlineThemeToken? { VDSThemeRegistry.shared.tabUnderline() }
