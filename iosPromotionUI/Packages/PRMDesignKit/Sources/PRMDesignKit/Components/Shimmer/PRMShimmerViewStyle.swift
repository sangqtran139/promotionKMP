//
//  PRMShimmerViewStyle.swift
//  CoreUIKit
//

import UIKit

public extension PRMShimmerView {
...
public struct PRMShimmerViewStyle: Equatable {
    ...
    public var effectSpan: PRMShimmerView.EffectSpan

    /// The tilt angle of the effect. Please specify using radian.
    public var effectAngle: CGFloat
    
    public init(baseColor: UIColor, highlightColor: UIColor, duration: CFTimeInterval, interval: CFTimeInterval, effectSpan: PRMShimmerView.EffectSpan, effectAngle: CGFloat) {
...
public extension PRMShimmerViewStyle {
    static let `default` = PRMShimmerViewStyle(baseColor: Colors.tokenDark20, highlightColor: Colors.tokenDark10, duration: 1, interval: 0.4, effectSpan: .points(100), effectAngle: 0 * CGFloat.pi)
}
