...
@IBDesignable
public class VDSSearchTextField: UITextField {

    /// Left image of VDSSearchTextField
    ...
    private let bundle = Bundle(for: VDSSearchTextField.self)
    ...
    private var themeToken: VDSSearchBarThemeToken? { VDSThemeRegistry.shared.searchBar() }

    private let imageSearchWhite = UIImage.sdk("ic_search_16_white", in: Bundle(for: VDSSearchTextField.self))
