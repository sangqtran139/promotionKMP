//
//  VDSShimmerReplicatorView.swift
//  CoreUIKit
//

import UIKit

/// This class replicates the specified `VDSShimmerReplicatorViewCell` inside its frame in horizontal and vertical direction.
/// This class make it easy to create list type loading indicator very easily.
public class VDSShimmerReplicatorView: UIView {//swiftlint:disable line_length
    ...
    private let cellProvider: () -> VDSShimmerReplicatorViewCell
    ...
    ///   - cellProvider: A closure to create an instance of `VDSShimmerReplicatorViewCell`.
    public init(itemSize: ItemSize, interitemSpacing: CGFloat = 0, lineSpacing: CGFloat = 0, inset: UIEdgeInsets = .zero, horizontalEdgeMode: EdgeMode = .beyond, verticalEdgeMode: EdgeMode = .beyond, cellProvider: @escaping () -> VDSShimmerReplicatorViewCell) {
    ...
    public func startAnimating() {
        isAnimating = true
        stackView.arrangedSubviews.compactMap { $0 as? VDSShimmerReplicatorViewCell }.forEach {
            $0.startAnimating()
        }
    }
