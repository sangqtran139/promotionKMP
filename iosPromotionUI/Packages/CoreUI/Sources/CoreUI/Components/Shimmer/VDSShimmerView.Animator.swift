...
extension VDSShimmerSyncTarget {
...
internal extension VDSShimmerView {
    class Animator {
        let shimmerView: VDSShimmerView
        let syncTarget: VDSShimmerSyncTarget
        
        init(shimmerView: VDSShimmerView) {
