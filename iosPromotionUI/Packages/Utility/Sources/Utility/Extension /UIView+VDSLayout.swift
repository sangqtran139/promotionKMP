...
public class VDSAnchorMaker {
    ...
    @discardableResult public func top(equalTo anchor: NSLayoutYAxisAnchor, constant: CGFloat = 0) -> VDSAnchorMaker {
        view.topAnchor.constraint(equalTo: anchor, constant: constant).isActive = true
        return self
    }
    
    @discardableResult public func bottom(equalTo anchor: NSLayoutYAxisAnchor, constant: CGFloat = 0) -> VDSAnchorMaker {
        view.bottomAnchor.constraint(equalTo: anchor, constant: constant).isActive = true
        return self
    }
    
    @discardableResult public func leading(equalTo anchor: NSLayoutXAxisAnchor, constant: CGFloat = 0) -> VDSAnchorMaker {
        view.leadingAnchor.constraint(equalTo: anchor, constant: constant).isActive = true
        return self
    }
    
    @discardableResult public func trailing(equalTo anchor: NSLayoutXAxisAnchor, constant: CGFloat = 0) -> VDSAnchorMaker {
        view.trailingAnchor.constraint(equalTo: anchor, constant: constant).isActive = true
        return self
    }
    
    @discardableResult public func centerX(equalTo anchor: NSLayoutXAxisAnchor, constant: CGFloat = 0) -> VDSAnchorMaker {
        view.centerXAnchor.constraint(equalTo: anchor, constant: constant).isActive = true
        return self
    }
    
    @discardableResult public func centerY(equalTo anchor: NSLayoutYAxisAnchor, constant: CGFloat = 0) -> VDSAnchorMaker {
        view.centerYAnchor.constraint(equalTo: anchor, constant: constant).isActive = true
        return self
    }
    
    @discardableResult public func width(equalTo constant: CGFloat) -> VDSAnchorMaker {
        view.widthAnchor.constraint(equalToConstant: constant).isActive = true
        return self
    }
    
    @discardableResult public func height(equalTo constant: CGFloat) -> VDSAnchorMaker {
        view.heightAnchor.constraint(equalToConstant: constant).isActive = true
        return self
    }
    
    @discardableResult public func width(equalTo dimension: NSLayoutDimension, multiplier: CGFloat = 1.0, constant: CGFloat = 0) -> VDSAnchorMaker {
        view.widthAnchor.constraint(equalTo: dimension, multiplier: multiplier, constant: constant).isActive = true
        return self
    }
    
    @discardableResult public func height(equalTo dimension: NSLayoutDimension, multiplier: CGFloat = 1.0, constant: CGFloat = 0) -> VDSAnchorMaker {
        view.heightAnchor.constraint(equalTo: dimension, multiplier: multiplier, constant: constant).isActive = true
        return self
    }
    
    @discardableResult public func leading(greaterThanOrEqualTo anchor: NSLayoutXAxisAnchor, constant: CGFloat = 0) -> VDSAnchorMaker {
        view.leadingAnchor.constraint(greaterThanOrEqualTo: anchor, constant: constant).isActive = true
        return self
    }
    
    @discardableResult public func trailing(lessThanOrEqualTo anchor: NSLayoutXAxisAnchor, constant: CGFloat = 0) -> VDSAnchorMaker {
        view.trailingAnchor.constraint(lessThanOrEqualTo: anchor, constant: constant).isActive = true
        return self
    }
    
    @discardableResult public func top(greaterThanOrEqualTo anchor: NSLayoutYAxisAnchor, constant: CGFloat = 0) -> VDSAnchorMaker {
        view.topAnchor.constraint(greaterThanOrEqualTo: anchor, constant: constant).isActive = true
        return self
    }
    
    @discardableResult public func bottom(lessThanOrEqualTo anchor: NSLayoutYAxisAnchor, constant: CGFloat = 0) -> VDSAnchorMaker {
        view.bottomAnchor.constraint(lessThanOrEqualTo: anchor, constant: constant).isActive = true
        return self
    }
    
    @discardableResult public func height(greaterThanOrEqualTo constant: CGFloat) -> VDSAnchorMaker {
        view.heightAnchor.constraint(greaterThanOrEqualToConstant: constant).isActive = true
        return self
    }
    
    @discardableResult public func size(_ size: CGSize) -> VDSAnchorMaker {
        view.widthAnchor.constraint(equalToConstant: size.width).isActive = true
        view.heightAnchor.constraint(equalToConstant: size.height).isActive = true
        return self
    }
    
    @discardableResult public func edges(to superview: UIView, insets: UIEdgeInsets = .zero) -> VDSAnchorMaker {
    ...
    @discardableResult public func center(in superview: UIView, offset: CGPoint = .zero) -> VDSAnchorMaker {
...
public extension UIView {
    func makeAnchor(_ closure: (VDSAnchorMaker) -> Void) {
        let maker = VDSAnchorMaker(view: self)
        closure(maker)
    }
