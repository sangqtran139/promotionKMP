...
final class MyPromotionViewModel: PRMBaseViewModel<MyPromotionRouter>, PRMViewModelType {
    ...
    private func buildOutput() -> Output {
        Output(
            ...
            promotions: stateSubject.map { $0.vouchers.map { MyPromotionCellViewModel(voucher: $0.source, isEnabled: $0.isEnabled, expiringInDays: $0.expiringInDays?.intValue) } }.eraseToAnyPublisher(),
