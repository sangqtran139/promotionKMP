...
data class RedemptionSessionRequest(
    ...
    @SerializedName("customerInfo") val customerInfo: CustomerInfo,
    @SerializedName("orderInfo") val orderInfo: OrderInfo,
    @SerializedName("selectedRedeemables") val selectedRedeemables: List<SelectedRedeemable> = emptyList(),
