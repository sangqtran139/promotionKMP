...
class SimpleSpanBuilder {
    ...
    fun appendWithSemiColon(text: String, vararg styles: CharacterStyle): SimpleSpanBuilder {
    ...
    fun appendWithHash(text: String, vararg styles: CharacterStyle): SimpleSpanBuilder {
        return append("$text#", *styles)
    }
