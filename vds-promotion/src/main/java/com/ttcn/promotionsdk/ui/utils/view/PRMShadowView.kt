...
open class PRMShadowView : FrameLayout {
    ...
    enum class ColorType {
        Solid, GradientLinear, GradientRadial, GradientSweep
    }
    ...
    enum class CornerType {
        Custom, Rectangular, Circular, Third, Quarter
    }
    ...
    private fun initialize(context: Context, attrs: AttributeSet?) {
        attrs.let {
            val typedArray = context.obtainStyledAttributes(it, R.styleable.PRMShadowView)
            // Get Background Style from XML
            var index = typedArray.getInteger(
                R.styleable.PRMShadowView_prmSvBackgroundType, DEFAULT_BACKGROUND_TYPE.ordinal
            )
            backgroundType = BackgroundType.values()[index]
            index = typedArray.getInteger(
                R.styleable.PRMShadowView_prmSvBackgroundColorType,
                DEFAULT_BACKGROUND_COLOR_TYPE.ordinal
            )
            backgroundColorType = ColorType.values()[index]
            bgColor = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvBackgroundColor, DEFAULT_COLOR_BACKGROUND
            )
            val defaultAlpha = NOT_DEFINED_ALPHA
            backgroundAlpha = floatPercentCheck(
                typedArray.getFloat(
                    R.styleable.PRMShadowView_prmSvBackgroundAlpha, defaultAlpha
                )
            )
            val defaultColor = NOT_DEFINED_COLOR
            bgGradientColorsXml[0] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvBackgroundGradientColor0, defaultColor
            )
            bgGradientColorsXml[1] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvBackgroundGradientColor1, defaultColor
            )
            bgGradientColorsXml[2] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvBackgroundGradientColor2, defaultColor
            )
            bgGradientColorsXml[3] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvBackgroundGradientColor3, defaultColor
            )
            bgGradientColorsXml[4] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvBackgroundGradientColor4, defaultColor
            )
            bgGradientColorsXml[5] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvBackgroundGradientColor5, defaultColor
            )
            bgGradientColorsXml[6] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvBackgroundGradientColor6, defaultColor
            )
            bgGradientColorsXml[7] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvBackgroundGradientColorEnd, defaultColor
            )
            val defaultAngle = NOT_DEFINED_ANGLE
            bgGradientAngle = angleCheck(
                typedArray.getFloat(
                    R.styleable.PRMShadowView_prmSvBackgroundGradientAngle, defaultAngle
                )
            )
            bgGradientOffCenterX = boundaryCheck(
                typedArray.getFloat(
                    R.styleable.PRMShadowView_prmSvBackgroundGradientOffCenterX,
                    DEFAULT_OFF_CENTER_X
                ), 1f
            )
            bgGradientOffCenterY = boundaryCheck(
                typedArray.getFloat(
                    R.styleable.PRMShadowView_prmSvBackgroundGradientOffCenterY,
                    DEFAULT_OFF_CENTER_Y
                ), 1f
            )
            index = typedArray.getInteger(
                R.styleable.PRMShadowView_prmSvStrokeColorType, DEFAULT_STROKE_COLOR_TYPE.ordinal
            )
            strokeColorType = ColorType.values()[index]
            strokeColor = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvStrokeColor, DEFAULT_COLOR_STROKE
            )
            strokeAlpha = floatPercentCheck(
                typedArray.getFloat(
                    R.styleable.PRMShadowView_prmSvStrokeAlpha, defaultAlpha
                )
            )
            strWidth = dimenCheck(
                typedArray.getDimension(
                    R.styleable.PRMShadowView_prmSvStrokeWidth, DEFAULT_STROKE_SIZE
                ), null
            )
            strokeGradientColorsXml[0] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvStrokeGradientColor0, defaultColor
            )
            strokeGradientColorsXml[1] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvStrokeGradientColor1, defaultColor
            )
            strokeGradientColorsXml[2] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvStrokeGradientColor2, defaultColor
            )
            strokeGradientColorsXml[3] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvStrokeGradientColor3, defaultColor
            )
            strokeGradientColorsXml[4] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvStrokeGradientColor4, defaultColor
            )
            strokeGradientColorsXml[5] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvStrokeGradientColor5, defaultColor
            )
            strokeGradientColorsXml[6] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvStrokeGradientColor6, defaultColor
            )
            strokeGradientColorsXml[7] = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvStrokeGradientColorEnd, defaultColor
            )
            strokeGradientAngle = angleCheck(
                typedArray.getFloat(
                    R.styleable.PRMShadowView_prmSvStrokeGradientAngle, defaultAngle
                )
            )
            strokeGradientOffCenterX = boundaryCheck(
                typedArray.getFloat(
                    R.styleable.PRMShadowView_prmSvStrokeGradientOffCenterX, DEFAULT_OFF_CENTER_X
                ), 1f
            )
            strokeGradientOffCenterY = boundaryCheck(
                typedArray.getFloat(
                    R.styleable.PRMShadowView_prmSvStrokeGradientOffCenterY, DEFAULT_OFF_CENTER_Y
                ), 1f
            )
            strokeDashSize = dimenCheck(
                typedArray.getDimension(
                    R.styleable.PRMShadowView_prmSvStrokeDashSize, defaultStrokeDashSize
                ), null
            )
            strokeGapSize = dimenCheck(
                typedArray.getDimension(
                    R.styleable.PRMShadowView_prmSvStrokeGapSize, defaultStrokeGapSize
                ), null
            )
            index = typedArray.getInteger(
                R.styleable.PRMShadowView_prmSvStrokeCapType, DEFAULT_STROKE_CAP_TYPE.ordinal
            )
            strokeCapType = CapType.values()[index]
            // Get Shadow Data from XML
            shadow.color = typedArray.getColor(
                R.styleable.PRMShadowView_prmSvShadowColor, DEFAULT_SHADOW_COLOR
            )
            shadow.alpha = floatPercentCheck(
                typedArray.getFloat(
                    R.styleable.PRMShadowView_prmSvShadowAlpha, NOT_DEFINED_ALPHA
                )
            )
            shadow.distance = dimenCheck(
                typedArray.getDimension(
                    R.styleable.PRMShadowView_prmSvShadowDistance, NOT_DEFINED_DIMEN
                ), NOT_DEFINED_DIMEN
            )
            shadow.blur = dimenCheck(
                typedArray.getDimension(
                    R.styleable.PRMShadowView_prmSvShadowBlur, NOT_DEFINED_DIMEN
                ), NOT_DEFINED_DIMEN
            )
            shadow.angle = angleCheck(
                typedArray.getFloat(
                    R.styleable.PRMShadowView_prmSvShadowAngle, NOT_DEFINED_ANGLE
                )
            )
            shadowSpace = dimenCheck(
                typedArray.getDimension(
                    R.styleable.PRMShadowView_prmSvShadowArea, NOT_DEFINED_SHADOW_SHADOW_AREA
                ), NOT_DEFINED_SHADOW_SHADOW_AREA
            )
            shadowLeft = dimenCheck(
                typedArray.getDimension(
                    R.styleable.PRMShadowView_prmSvShadowLeft, NOT_DEFINED_SHADOW_SHADOW_AREA
                ), NOT_DEFINED_SHADOW_SHADOW_AREA
            )
            shadowTop = dimenCheck(
                typedArray.getDimension(
                    R.styleable.PRMShadowView_prmSvShadowTop, NOT_DEFINED_SHADOW_SHADOW_AREA
                ), NOT_DEFINED_SHADOW_SHADOW_AREA
            )
            shadowRight = dimenCheck(
                typedArray.getDimension(
                    R.styleable.PRMShadowView_prmSvShadowRight, NOT_DEFINED_SHADOW_SHADOW_AREA
                ), NOT_DEFINED_SHADOW_SHADOW_AREA
            )
            shadowBottom = dimenCheck(
                typedArray.getDimension(
                    R.styleable.PRMShadowView_prmSvShadowBottom, NOT_DEFINED_SHADOW_SHADOW_AREA
                ), NOT_DEFINED_SHADOW_SHADOW_AREA
            )

            shadowDy = typedArray.getDimension(
                R.styleable.PRMShadowView_prmSvShadowDy, NOT_DEFINED_SHADOW_DY
            )

            // Get Corner Radius from XML
            val default = NOT_DEFINED_CORNER_RADIUS
            cornersRadius =
                typedArray.getDimension(R.styleable.PRMShadowView_prmSvCornerRadius, default)
            cornerRadiusTopLeft =
                typedArray.getDimension(R.styleable.PRMShadowView_prmSvCornerTopLeft, default)
            cornerRadiusTopRight =
                typedArray.getDimension(R.styleable.PRMShadowView_prmSvCornerTopRight, default)
            cornerRadiusBottomRight =
                typedArray.getDimension(R.styleable.PRMShadowView_prmSvCornerBottomRight, default)
            cornerRadiusBottomLeft =
                typedArray.getDimension(R.styleable.PRMShadowView_prmSvCornerBottomLeft, default)
            val position = typedArray.getInteger(
                R.styleable.PRMShadowView_prmSvCornerType, DEFAULT_CORNER_TYPE.ordinal
            )
    ...
    private fun initShadowArea() {
        if (shadowSpace == NOT_DEFINED_SHADOW_SHADOW_AREA) if (haveShadow() && shadowSpace != 0f) shadowSpace =
            defaultShadowArea
    }
    ...
    private fun initLayerTypes(vararg paints: Paint) {
        for (p in paints) if (android.os.Build.VERSION.SDK_INT < 28) setLayerType(
            View.LAYER_TYPE_SOFTWARE,
            p
        )
        else setLayerType(View.LAYER_TYPE_HARDWARE, p)
    }
...
//        addBackgroundRectF(shadow.mask)
    ...
    private fun initBackgroundPaint() {
        ...
        when (backgroundColorType) {
            ColorType.GradientLinear -> backgroundPaint.shader = getLinearShader(
                bgGradientColors, bgGradientAngle
            )

            ColorType.GradientRadial -> backgroundPaint.shader = getRadialShader(
                bgGradientColors, bgGradientOffCenterX, bgGradientOffCenterY
            )

            ColorType.GradientSweep -> backgroundPaint.shader = getSweepShader(
                bgGradientColors, bgGradientAngle, bgGradientOffCenterX, bgGradientOffCenterY
            )
    ...
    private fun initStrokePaint() {
        ...
        when (strokeColorType) {
            ColorType.GradientLinear -> strokePaint.shader = getLinearShader(
                strokeGradientColors, strokeGradientAngle
            )
    ...
    private fun getColorArray(colors: IntArray, alpha: Float): IntArray {
        ...
        for (c in colors) if (c != NOT_DEFINED_COLOR) colorArray.add(
            assignColorAlpha(c, alpha)
        )
        if (colors.last() == NOT_DEFINED_COLOR && colorArray.size != 0) colorArray.add(colorArray.first())
    ...
    private fun dimenCheck(dimen: Float, allowedDimen: Float?): Float {
        if (allowedDimen != null) if (dimen == allowedDimen) return dimen
        return if (dimen >= 0f) dimen
        else 0f
    }
    ...
    private fun addBackgroundRectF(path: Path) {
        path.addRoundRect(
            ...
            ), getBackgroundPathRadius(), Path.Direction.CW
        )
    }
    ...
    private fun addStrokePath(path: Path) {
        ...
        path.addRoundRect(
            ...
            ), getStrokePathRadius(), Path.Direction.CW
        )
    }
    ...
    private fun addNoStrokeAreaRectF(path: Path) {
        path.addRoundRect(
            ...
            ), getStrokeMaskRadius(), Path.Direction.CW
        )
    }
    ...
    private fun addBoundaryRectF(path: Path) {
        path.addRect(
            getRectF(
                measuredWidth.toFloat(), measuredHeight.toFloat(), 0f
            ), Path.Direction.CW
        )
    }
    ...
    private fun angleCheck(angle: Float): Float {
        return if (angle < 0) angleCheck(angle + 360)
        else angle % 360
    }
     ...
     *
     */
    private fun getSweepShader(
        colorArray: IntArray, angle: Float, offCenterX: Float, offCenterY: Float
    ): SweepGradient {
        val sweepGradient =
            SweepGradient(getCenterX(offCenterX), getCenterY(offCenterY), colorArray, null)
        val matrix = Matrix()
     ...
     *
     */
    private fun getRadialShader(
        colorArray: IntArray, offCenterX: Float, offCenterY: Float
    ): RadialGradient {
    ...
    private fun getCenterY(offCenter: Float): Float {
        val halfHeight =
            getActualHeight() / 2 + (getShadowShadowTop() + getShadowShadowBottom()) / 2
    ...
    private fun getLinearGradientCircularStartPoint(angle: Float): Pair<Float, Float> {
        ...
        var y = halfHeight + boundaryCheck(
            -dy, halfHeight
        ) // -dy because y axis in android is upside down.
    ...
    private fun getStrokeWidth(): Float {
        return if (canDrawStroke()) strWidth
        else 0f
    }
    ...
    private fun getShadowArea(): Float {
        return if (shadowSpace == NOT_DEFINED_SHADOW_SHADOW_AREA) 0f
        else shadowSpace
    }

    private fun getShadowShadowLeft(): Float {
        return if (shadowLeft == NOT_DEFINED_SHADOW_SHADOW_AREA) getShadowArea()
        else shadowLeft
    }

    private fun getShadowShadowTop(): Float {
        return if (shadowTop == NOT_DEFINED_SHADOW_SHADOW_AREA) getShadowArea()
        else shadowTop
    }

    private fun getShadowShadowRight(): Float {
        return if (shadowRight == NOT_DEFINED_SHADOW_SHADOW_AREA) getShadowArea()
        else shadowRight
    }

    private fun getShadowShadowBottom(): Float {
        return if (shadowBottom == NOT_DEFINED_SHADOW_SHADOW_AREA) getShadowArea()
        else shadowBottom
    }
    ...
    private fun canDrawShadow(shadow: ShadowObject): Boolean {
        if (getShadowShadowLeft() == 0f && getShadowShadowTop() == 0f && getShadowShadowRight() == 0f && getShadowShadowBottom() == 0f) return false
