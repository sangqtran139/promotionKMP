...
import com.ttcn.promotionsdk.ui.presentation.promotion.myendow.adapter.ChooseEndowAdapter
import com.ttcn.promotionsdk.ui.presentation.promotion.myendow.adapter.EndowListItem
 ...
 * Không tự tạo data
 */
class ChooseEndowFragment :
    PRMBaseFragment<PromotionViewModel, PrmFragmentChooseEndowBinding>() {
    ...
    override val layoutId: Int = R.layout.prm_fragment_choose_endow
    ...
    private fun setupSearch() {
        binding.edtVoucher.apply {
            ...
            setOnSearchActionListener {
                performFilter(
                    viewBinding.searchInput.text.toString()
                )
            }
