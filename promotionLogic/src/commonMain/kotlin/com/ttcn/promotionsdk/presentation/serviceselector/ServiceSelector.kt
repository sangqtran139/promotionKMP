 ...
 *
 * **Tầng UI-logic dùng chung** — trước đây trùng ở Android (`*ViewModel.openServiceSelector`) và iOS
 * (`ServiceSelectorBuilder.items`). Nay cả hai gọi hàm này; mỗi nền tảng chỉ map [AvailableService]
