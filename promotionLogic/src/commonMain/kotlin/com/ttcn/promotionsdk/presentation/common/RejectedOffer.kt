 ...
 *
 * Ở `presentation/common` chứ không nằm hẳn trong `presentation/offerwidget`: nó do
 * [OfferWidgetStore][com.ttcn.promotionsdk.presentation.offerwidget.OfferWidgetStore] sinh ra nhưng
 ...
 */
public data class RejectedOffer(
    val objectId: String,
    val message: String,
)
